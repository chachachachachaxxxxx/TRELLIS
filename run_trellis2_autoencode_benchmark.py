...
ENTRYPOINT_NAME = "trellis2_autoencode"
...
def main() -> None:
    ...
    if len(generate_gpu_ids) > 1:
        ...
        selected_prompt_cases = [
            (dataset, object_name, prompt_id)
